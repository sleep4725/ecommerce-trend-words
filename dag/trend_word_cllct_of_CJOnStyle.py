...
with DAG (
    ...
    run_script= "{py_interpreter} {py_file}".format(
	    ...
	    ,py_file='/Users/kimjunhyeon/popular-search-terms/cllctr/cjonstyle/CJOnStyleApplication.py'
    )
    
    trend_rank_word_of_cj_onstyle= BashOperator(
        task_id= f'trend-rank-word-{FLAG}'
        , bash_command= run_script
        , dag= dag
    )
    
    trend_rank_word_of_cj_onstyle 